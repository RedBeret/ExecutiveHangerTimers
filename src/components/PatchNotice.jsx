    ...
    <aside className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-4 text-sm text-amber-100">
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1">
          <h2 className="font-bold text-amber-200">Alpha 4.8 Contested Zone Notice</h2>
          <p>
            Star Citizen Alpha 4.8 lists keycard printer timers as a known issue. Use CZ Timer as a manual Pyro
